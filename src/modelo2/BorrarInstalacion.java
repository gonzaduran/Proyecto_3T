...
public class BorrarInstalacion extends JFrame {
	...
	public BorrarInstalacion() {
		...
		lblBAJAS.setBounds(109, 25, 246, 14);
		...
		JLabel lblNúmeroSocio = new JLabel("NÚMERO INSTALACIÓN");
		...
		textField.setBounds(187, 111, 86, 20);
		contentPane.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(187, 158, 86, 20);
